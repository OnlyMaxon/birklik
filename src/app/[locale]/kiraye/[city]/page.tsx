...
//
// Выдуманный регион отдаёт настоящий 404, но решает это не страница, а
// `layout.tsx` рядом: он считается ДО границы Suspense, которую открывает
// `loading.tsx`, и успевает выставить статус. Вызов notFound() ниже оставлен
// страховкой на случай, если layout когда-нибудь уберут.
//
// Noindex в generateMetadata тоже остаётся: метаданные считаются параллельно
// со страницей и могут уйти вперёд неё.
//
