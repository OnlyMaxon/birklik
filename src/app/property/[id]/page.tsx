...
// Несуществующее объявление отдаёт настоящий 404: `layout.tsx` рядом считает
// существование ДО границы Suspense, поэтому статус успевает уйти в заголовках.
// Работает это с 2026-09-22, когда с переходом на Workers Paid удалён корневой
// `src/app/loading.tsx` — он открывал поток раньше всех и обнулял проверку.
//
// Мета-теги ниже всё равно нужны: `generateMetadata` считается параллельно со
// страницей и может успеть уйти вперёд неё. Noindex и БЕЗ canonical — canonical
// на несуществующий адрес был прямым приглашением его проиндексировать.
