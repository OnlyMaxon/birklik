...
export function FavoriteButton({propertyId, initialIsFavorited, isAuthenticated}: FavoriteButtonProps) {
  ...
  return (
    ...
    >
      {isPending ? <InlineSpinner label="Updating bookmark" /> : <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
