...
export const az: Translations = {
  ...
  home: {
    ...
    topListingsTitle: "Seçilmiş evlər və istirahət mərkəzləri",
  ...
  common: {
    ...
    maxWords: "Standart paket üçün maksimum 100 söz",
    minPhotos: "Ən azı 5 şəkil əlavə edin",
  ...
  listing: {
    ...
    minPhotos: "Zəhmət olmasa ən azı 5 fotoşəkil əlavə edin",
    maxWordsStandard: "Standart plan üçün maksimum 100 söz",
