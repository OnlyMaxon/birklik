...
export const cities: CityOption[] = [
  ...
  { value: 'Agjabadi', az: 'Ağcabədi', en: 'Agjabadi', ru: 'Агджабади' },
  ...
  { value: 'Beylacan', az: 'Beyləqan', en: 'Beylacan', ru: 'Бейлеган' },
  ...
  { value: 'Gadabay', az: 'Gədəbəy', en: 'Gadabay', ru: 'Геданеч' },
  { value: 'Goranboy', az: 'Goranboy', en: 'Goranboy', ru: 'Геранбой' },
  { value: 'Goychay', az: 'Göyçay', en: 'Goychay', ru: 'Гейчай' },
  { value: 'Goygol', az: 'Göygöl', en: 'Goygol', ru: 'Гейгель' },
  { value: 'Haciqabul', az: 'Hacıqabul', en: 'Haciqabul', ru: 'Хачикабул' },
  ...
  { value: 'Khankandi', az: 'Xankəndi', en: 'Khankandi', ru: 'Ханкенди' },
  { value: 'Khinali', az: 'Xınalı', en: 'Khinali', ru: 'Ханалы' },
  { value: 'Xirdalan', az: 'Xırdalan', en: 'Xirdalan', ru: 'Хырдалан' },
  { value: 'Khizi', az: 'Xızı', en: 'Khizi', ru: 'Хизи' },
  { value: 'Qakh', az: 'Qax', en: 'Qakh', ru: 'Ках' },
  { value: 'Qazakh', az: 'Qazax', en: 'Qazakh', ru: 'Казах' },
  ...
  { value: 'Kurdemir', az: 'Kürdəmir', en: 'Kurdemir', ru: 'Кюрдамир' },
  ...
  { value: 'Salyan', az: 'Salyan', en: 'Salyan', ru: 'Салян' },
  { value: 'Samukh', az: 'Samux', en: 'Samukh', ru: 'Самух' },
  { value: 'Siyazan', az: 'Siyəzən', en: 'Siyazan', ru: 'Сиязань' },
  { value: 'Shabran', az: 'Şabran', en: 'Shabran', ru: 'Шабран' },
  { value: 'Shamkir', az: 'Şəmkir', en: 'Shamkir', ru: 'Шамкир' },
  { value: 'Terter', az: 'Tərtər', en: 'Terter', ru: 'Тартар' },
  { value: 'Tovuz', az: 'Tovuz', en: 'Tovuz', ru: 'Товуз' },
  { value: 'Yardymly', az: 'Yardımlı', en: 'Yardymly', ru: 'Ярдымлы' },
