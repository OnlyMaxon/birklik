...
export const nearFilterOptions: FilterOption[] = [
  { key: 'mountains', az: 'Daglar', en: 'Mountains' },
  { key: 'forest', az: 'Mesh', en: 'Forest' },
  { key: 'sea', az: 'Deniz', en: 'Sea' },
  { key: 'riverLake', az: 'Cay ve ya gol', en: 'River or lake' },
  { key: 'resortCenters', az: 'Istirahet merkezleri', en: 'Resort centers' },
...
export const cityLocationOptions: Record<LocationCategory, FilterOption[]> = {
  rayon: [
    ...
    { key: 'nerimanov', az: 'Nerimanov', en: 'Narimanov' },
    { key: 'nesimi', az: 'Nesimi', en: 'Nasimi' },
    { key: 'xetai', az: 'Xetai', en: 'Khatai' },
    { key: 'sabail', az: 'Sebail', en: 'Sabail' },
    { key: 'bineqedi', az: 'Bineqedi', en: 'Binagadi' },
    { key: 'qaradag', az: 'Qaradag', en: 'Garadagh' },
    { key: 'xezar', az: 'Xezer', en: 'Khazar' },
    { key: 'suraxani', az: 'Suraxani', en: 'Surakhani' },
    { key: 'pirallahi', az: 'Pirallahi', en: 'Pirallahi' },
    { key: 'abseron', az: 'Abseron', en: 'Absheron' },
    { key: 'xirdalan', az: 'Xirdalan', en: 'Khirdalan' },
    { key: 'sumqayitDistrict', az: 'Sumqayit rayonu', en: 'Sumgait district' },
    { key: 'salyanHighway', az: 'Salyan sossesi', en: 'Salyan highway' },
    { key: 'bayil', az: 'Bayil', en: 'Bayil' },
    { key: 'badamdar', az: 'Badamdar', en: 'Badamdar' },
    { key: '8km', az: '8-ci km', en: '8th km' },
    { key: 'mehemmedi', az: 'Mehemmedi', en: 'Mammadli' },
    { key: 'mashtaga', az: 'Mashtaga', en: 'Mashtaga' },
    { key: 'zabrat', az: 'Zabrat', en: 'Zabrat' },
    { key: 'sabuncu', az: 'Sabuncu', en: 'Sabunchu' },
    { key: 'ramana', az: 'Ramana', en: 'Ramana' },
    { key: 'amirjan', az: 'Emircan', en: 'Amirjan' },
    { key: 'lokbatan', az: 'Lokbatan', en: 'Lokbatan' },
    { key: 'turkan', az: 'Turkan', en: 'Turkan' },
    { key: 'hokmeli', az: 'Hokmeli', en: 'Hokmali' },
    { key: 'saray', az: 'Saray', en: 'Saray' },
    { key: 'hovsan', az: 'Hovsan', en: 'Hovsan' },
    { key: 'zil', az: 'Zigh', en: 'Zigh' }
  ],
  metro: [
    { key: '20yanvar', az: '20 Yanvar', en: '20 Yanvar' },
    { key: '28may', az: '28 May', en: '28 May' },
    { key: '8noyabr', az: '8 Noyabr', en: '8 November' },
    { key: 'avtovagzal', az: 'Avtovagzal', en: 'Avtovagzal' },
    { key: 'azadliqprospekti', az: 'Azadliq Prospekti', en: 'Azadlig Prospekti' },
    { key: 'bakmil', az: 'Bakmil', en: 'Bakmil' },
    { key: 'dernegul', az: 'Dernegul', en: 'Darnagul' },
    { key: 'elmler', az: 'Elmler Akademiyasi', en: 'Elmler Akademiyasi' },
    { key: 'ehmedli', az: 'Ehmedli', en: 'Ahmadli' },
    { key: 'genclik', az: 'Genclik', en: 'Ganjlik' },
    { key: 'heziaslanov', az: 'Hezi Aslanov', en: 'Hazi Aslanov' },
    { key: 'xalqlardostlugu', az: 'Xalqlar Dostlugu', en: 'Khalklar Dostlugu' },
    { key: 'xocesen', az: 'Xocesen', en: 'Khojasan' },
    { key: 'iceriseher', az: 'Iceriseher', en: 'Icherisheher' },
    { key: 'insaatcilar', az: 'Insaatcilar', en: 'Inshaatchilar' },
    { key: 'koroglu', az: 'Koroglu', en: 'Koroglu' },
    { key: 'qaraqarayev', az: 'Qara Qarayev', en: 'Qara Qarayev' },
    { key: 'memarEcemi', az: 'Memar Ecemi', en: 'Memar Ajami' },
    { key: 'neftciler', az: 'Neftciler', en: 'Neftchilar' },
    { key: 'nerimanov', az: 'Neriman Nerimanov', en: 'Nariman Narimanov' },
    { key: 'nesimiStation', az: 'Nesimi', en: 'Nasimi' },
    { key: 'nizamiStation', az: 'Nizami', en: 'Nizami' },
    { key: 'sahil', az: 'Sahil', en: 'Sahil' },
    { key: 'sahismayilxetai', az: 'Sah Ismayil Xetai', en: 'Shah Ismayil Khatai' },
  ...
  landmark: [
    ...
    { key: 'ganjlikMall', az: 'Genclik Mall', en: 'Ganjlik Mall' },
    { key: 'denizkenari', az: 'Denizkenari bulvar', en: 'Seaside boulevard' },
    { key: 'nizamiStreet', az: 'Nizami kucesi', en: 'Nizami street' },
    { key: 'whiteCity', az: 'White City', en: 'White City' },
    { key: 'heydarAliyevCenter', az: 'Heyder Eliyev Merkezi', en: 'Heydar Aliyev Center' },
    { key: 'oldCity', az: 'Iceriseher', en: 'Old City' },
    { key: 'bakuEye', az: 'Baku Eye', en: 'Baku Eye' },
    { key: 'crystalHall', az: 'Baku Crystal Hall', en: 'Baku Crystal Hall' },
    { key: 'seaMall', az: 'Deniz Mall', en: 'Deniz Mall' },
    { key: 'winterPark', az: 'Qis parki', en: 'Winter Park' },
    { key: 'highlandPark', az: 'Dagustu park', en: 'Highland Park' },
    { key: 'nizamiMall', az: '28 Mall', en: '28 Mall' },
    { key: 'metroPark', az: 'Metro Park', en: 'Metro Park' },
    { key: 'korogluPark', az: 'Koroglu parki', en: 'Koroglu Park' },
    { key: 'gobustan', az: 'Qobustan qayaustu', en: 'Gobustan rock art' },
    { key: 'ateshgah', az: 'Atesgah mebedi', en: 'Ateshgah temple' },
    { key: 'yanardag', az: 'Yanardag', en: 'Yanar Dag' },
