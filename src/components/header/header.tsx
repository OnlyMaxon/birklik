...
import { getPendingModerationCount } from '../../services/property-service'
      ...
      <div className="header-content">
        <div className="logo" onClick={handleLogoClick} role="button" tabIndex={0} style={{ cursor: 'pointer' }}>
          <picture>
            ...
            <OptimizedImage priority loading="eager" className="logo-image" src="/brand/generated/logo-1024x256.png" alt="Birklik.az" width="1024" height="256" sizes="(max-width: 768px) 180px, 240px" />
          </picture>
        </div>
